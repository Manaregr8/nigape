            ...
            <div className="lg:col-span-1">
              <div className="sticky top-28 hidden lg:block">
                <div className="bg-black/30 backdrop-blur-sm border border-[#FF40EB]/40 rounded-2xl p-6 space-y-5">
                  ...
                  <a href="/contact-us" className="w-full py-3 mt-2 bg-gradient-to-r from-[#FF40EB] to-[#FF40EB] rounded-lg font-bold text-black hover:opacity-90 transition-opacity flex items-center justify-center">
                    Enroll Now
                  </a>
                </div>
              </div>
